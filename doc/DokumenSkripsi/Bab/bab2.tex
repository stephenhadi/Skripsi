...
\begin{itemize}
	...
	Atribut \texttt{data-toggle} dipasang dengan nilai \texttt{data-toggle=``tab''} agar navigasi dapat diklik dan melakukan navigasi.
...
<a class="nav-link">link</a>	
	\end{lstlisting}
\end{itemize}
Struktur penggunaan kelas-kelas pada \textit{nav} secara dasar:
\begin{lstlisting}
...
\end{lstlisting}
Penambahan atribut \texttt{data-toggle=``tab''} pada \textit{tag} \texttt{<a>}, memungkinkan navigasi dapat diklik. Kode diatas akan menghasilkan navigasi pada gambar \ref{fig:nav-tabs}.
