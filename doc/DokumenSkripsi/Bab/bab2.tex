...
\section{Bootstrap}
\textit{Bootstrap} adalah \textit{framework} paling terkenal untuk membuat \textit{site} yang \textit{mobile-first} dan \textit{res\-pon\-sive}\cite{bootstrap}. Versi \textit{browser} dan \textit{mobile} yang dapat menjalankan \textit{bootstrap} dapat dilihat pada tabel.
...
\begin{table}[H]
	\begin{tabular}{|l|l|l|l|}	
		...
		\hline
	\end{tabular}
	\caption{Browser yang mendukung \textit{bootstrap}}
	\label{tab:bootstrap supported}
\end{table}
