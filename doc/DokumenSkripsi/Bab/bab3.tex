...
\begin{table}[H]
	...
	8 & Menambahkan jam kuliah selesai di perubahan kelas & \#12 & Akan diimplementasi & \ref{issue:12} \\ \hline
	9 & \makecell[l]{Notifikasi email untuk mahasiswa \\ jika permintaan sudah diselesaikan} & \#17 & Akan diimplementasi &  \ref{issue:17}\\ \hline
	10 & Pagination tidak terstyle dengan baik & \#22 & Akan diimplementasi & \ref{issue:22}\\ \hline
	11 & Format Datetimepicker tidak konsisten &\#23 & Akan diimplementasi & \ref{issue:23}\\ \hline
	12 & Mengubah atau membatalkan permohonan & \#11 & Akan diimplementasi & \ref{issue:11} \\ \hline
	13 & Halaman histori dan request transkrip terpisah & \#19 & Akan diimplementasi & \ref{issue:19}\\ \hline
	14 & Menyediakan forum Q\&A pada \textit{bluetape} & \#9 & Tidak diimplementasi & \ref{issue:9}\\ \hline
